...
public class excel2 {
	public static void main(String[] args) throws Exception{ 
		try { // 경로에 있는 파일을 읽 
			FileInputStream file = new FileInputStream("C:\\Users\\zx040\\eclipse-workspace\\excelDownTest.xlsx"); 
			XSSFWorkbook workbook = new XSSFWorkbook(file); 
			int rowNo = 0; int cellIndex = 0; XSSFSheet sheet = workbook.getSheetAt(0); // 0 번째 시트를 가져온다 
