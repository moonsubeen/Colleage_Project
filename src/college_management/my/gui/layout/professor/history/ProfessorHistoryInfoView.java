...
public class ProfessorHistoryInfoView extends LecView{
	...
	public ProfessorHistoryInfoView() {
		super();
	...
	private void initLayout() {
		...
		genInfoPair("점수", gradeTxtField, row++, true);
		genInfoPair("등급", rankTxtField, row++, false);
		genInfoPair("문제제기", problemTxtField, row++, false);
		genInfoPair("강의평가", evaluationTxtField, row++, false);
	}
