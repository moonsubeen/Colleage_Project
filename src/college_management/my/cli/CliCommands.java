...
@Command(name = "", 
		...
		subcommands = { PrintInfo.class, ClearScreen.class, CommandLine.HelpCommand.class, CLIRegister.class, CLIRead.class, 
						CLIPwdUpdate.class, CLIEmailUpdate.class, CLIAddressUpdate.class, CLIPhoneUpdate.class,CLILogin.class, CLILogout.class})
