...
- 수업을 듣을 강의의 강의코드를 입력하여 강의의 정보를 읽어보고 강의 신청을 한다.
- 자신이 듣고 있는 강의의 강의코드를 입력하여 출석정보를 확인한다.
- 자신이 듣고 있는 강의의 강의코드를 입력하여 강의평가를 한다.
- 자신이 듣고 있는 강의의 점수를 확인한다.
- 자신의 강의 점수가 이의가 있어 이의제기를 신청한다.
	```
	> login 2018 0000
	> read // read -s // read -f // read -sd // read -d
	> update -p 123asdf -a 서울 -e rlfehd@gmail.com
	> read -l -c 543013 // register lecture2 -c 543013 
